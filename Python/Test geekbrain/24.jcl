...
<gap-fill>import builtins
def open(path):                                                                      # <question-record><question></question><answer><text>norm</text><feedback></feedback><correct>1</correct></answer><clue>norm</clue></question-record> 
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;return builtins.open(path, &apos;r&apos;)

def open(path):
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;global open
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;return open(path, &apos;r&apos;)                    # <question-record><question></question><answer><text>mistake</text><feedback></feedback><correct>1</correct></answer><clue>mistake</clue></question-record> 

def open(path):
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;return globals()[&apos;open&apos;](path, &apos;r&apos;)     # <question-record><question></question><answer><text>mistake</text><feedback></feedback><correct>1</correct></answer><clue>mistake</clue></question-record> 
