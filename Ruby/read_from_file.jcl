...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>&amp;#x0427;&amp;#x0442;&amp;#x0435;&amp;#x043D;&amp;#x0438;&amp;#x0435; &amp;#x0438;&amp;#x0437; &amp;#x0444;&amp;#x0430;&amp;#x0439;&amp;#x043B;&amp;#x0430;</dc:title>
  </rdf:Description>
...
<gap-fill>read
----------
f = <question-record><question></question><answer><text>File.new</text><feedback></feedback><correct>1</correct></answer><clue>File.new</clue></question-record>(&quot;lib/file.rb&quot;)
content = <question-record><question></question><answer><text>f.read</text><feedback></feedback><correct>1</correct></answer><clue> f.read</clue></question-record> 
f.close

gets
----------
f = <question-record><question></question><answer><text>File.new</text><feedback></feedback><correct>1</correct></answer><clue>File.new</clue></question-record>(&quot;lib/file.rb&quot;)
while line = <question-record><question></question><answer><text>f.gets</text><feedback></feedback><correct>1</correct></answer><clue> f.gets</clue></question-record> 
____puts line
end
<question-record><question></question><answer><text>f.close</text><feedback></feedback><correct>1</correct></answer><clue>f.close</clue></question-record> 


each
-----------
f = <question-record><question></question><answer><text>File.new</text><feedback></feedback><correct>1</correct></answer><clue>File.new</clue></question-record>(&quot;lib/file.rb&quot;)
f.<question-record><question></question><answer><text>each</text><feedback></feedback><correct>1</correct></answer><clue>each </clue></question-record> do |line|
________#&amp;#x0434;&amp;#x0435;&amp;#x043B;&amp;#x0430;&amp;#x0435;&amp;#x043C; &amp;#x0447;&amp;#x0442;&amp;#x043E;-&amp;#x0442;&amp;#x043E; &amp;#x0441;&amp;#x043E; &amp;#x0441;&amp;#x0442;&amp;#x0440;&amp;#x043E;&amp;#x043A;&amp;#x043E;&amp;#x0439;
end
f.close</gap-fill>
</data>
