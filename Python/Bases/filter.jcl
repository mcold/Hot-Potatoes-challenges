...
<gap-fill>&amp;#x003E;&amp;#x003E;&amp;#x003E; l_num = [10, 13, 5, 67, 101, 4]
&amp;#x003E;&amp;#x003E;&amp;#x003E; l_res = <question-record><question></question><answer><text>list(filter(lambda x: x &amp;#x003E; 12, l_num))</text><feedback></feedback><correct>1</correct></answer><clue>list(filter(lambda x: x &amp;#x003E; 12, l_num))</clue></question-record>                                   
&amp;#x003E;&amp;#x003E;&amp;#x003E; l_res
[13, 67, 101]
...
&amp;#x003E;&amp;#x003E;&amp;#x003E; l_res = <question-record><question></question><answer><text>list(filter(lambda x: x &amp;#x003E; 0, l_num))</text><feedback></feedback><correct>1</correct></answer><clue>list(filter(lambda x: x &amp;#x003E; 0, l_num))</clue></question-record> 
&amp;#x003E;&amp;#x003E;&amp;#x003E; l_res
[10, 67, 4]
...
newList = <question-record><question></question><answer><text>filter(lambda x: x % 2 == 0, list)</text><feedback></feedback><correct>1</correct></answer><clue>filter(lambda x: x % 2 == 0, list)    </clue></question-record>                       # &amp;#x043E;&amp;#x0441;&amp;#x0442;&amp;#x0430;&amp;#x0432;&amp;#x043B;&amp;#x044F;&amp;#x0435;&amp;#x043C; &amp;#x0442;&amp;#x043E;&amp;#x043B;&amp;#x044C;&amp;#x043A;&amp;#x043E; &amp;#x0447;&amp;#x0435;&amp;#x0442;&amp;#x043D;&amp;#x044B;&amp;#x0435; &amp;#x0447;&amp;#x0438;&amp;#x0441;&amp;#x043B;&amp;#x0430; &amp;#x0432; &amp;#x0441;&amp;#x043F;&amp;#x0438;&amp;#x0441;&amp;#x043A;&amp;#x0435;
print(newList)</gap-fill>
</data>
