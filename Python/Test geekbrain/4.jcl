...
<gap-fill>x = input(&apos;Enter a number: &apos;)
print(x*2)


-------------
<question-record><question></question><answer><text>55</text><feedback></feedback><correct>1</correct></answer><clue>55</clue></question-record> </gap-fill>
</data>
