...
<gap-fill>s = {1, 2, 3}
s.add(4)                        # <question-record><question></question><answer><text>norm</text><feedback></feedback><correct>1</correct></answer><clue>norm</clue></question-record> 
s.insert(4)                     # <question-record><question></question><answer><text>mistake</text><feedback></feedback><correct>1</correct></answer><clue>mistake</clue></question-record> 
s.append(4)                   # <question-record><question></question><answer><text>mistake</text><feedback></feedback><correct>1</correct></answer><clue>mistake</clue></question-record> 
print(s)</gap-fill>
</data>
