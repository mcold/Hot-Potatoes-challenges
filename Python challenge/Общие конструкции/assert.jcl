...
<gap-fill>try:
    <question-record><question></question><answer><text>assert</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record>(s_max == a or s_max == b) and s_max &amp;#x003E;= a and s_max &amp;#x003E;= b
except <question-record><question></question><answer><text>AssertionError</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record>:
    print(&quot;Maximum a little bit&quot;)</gap-fill>
</data>
