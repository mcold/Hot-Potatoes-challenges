...
________@width, @height = w, h
   ____end
   ____# define to_s method
   ____def to_s
      ________&quot;(w:#@width,h:#@height)&quot;  # string formatting of the object.
   ____end
end
...
puts &quot;String representation of box is : #{box}&quot;</gap-fill>
</data>
