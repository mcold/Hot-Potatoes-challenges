...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>Access Control</dc:title>
  </rdf:Description>
...
<gap-fill>#!/usr/bin/ruby -w

# define a class
class Box
   ____# constructor method
   ____def initialize(w,h)
      ________@width, @height = w, h
   end

   ____# instance method by default it is public
   ____def getArea
      ________getWidth() * getHeight
   ____end

   ____# define private accessor methods
   ____def getWidth
      ________@width
   ____end
   ____def getHeight
      ________@height
   ____end
   ____# make them private
   ____<question-record><question></question><answer><text>private :getWidth, :getHeight</text><feedback></feedback><correct>1</correct></answer><clue>private :getWidth, :getHeight</clue></question-record> 

   ____# instance method to print area
   ____def printArea
      ________@area = getWidth() * getHeight
      ________puts &quot;Big box area is : #@area&quot;
   ____end
   ____# make it protected
   ____<question-record><question></question><answer><text>protected :printArea</text><feedback></feedback><correct>1</correct></answer><clue>protected :printArea</clue></question-record> 
end
...
&amp;#x003C;Box:0xb7f11280 @height = 20, @width = 10&amp;#x003E; (NoMethodError)</gap-fill>
</data>
