...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>recursion: factorial</dc:title>
  </rdf:Description>
...
factorial()
{
____if <question-record><question></question><answer><text>[ &quot;$1&quot; -gt &quot;1&quot; ]; then</text><feedback></feedback><correct>1</correct></answer><clue>[ &quot;$1&quot; -gt &quot;1&quot; ]; then</clue></question-record> 
________i=<question-record><question></question><answer><text>`expr $1 - 1`</text><feedback></feedback><correct>1</correct></answer><clue>`expr $1 - 1`</clue></question-record> 
________j=<question-record><question></question><answer><text>`factorial $i`</text><feedback></feedback><correct>1</correct></answer><clue>`factorial $i`</clue></question-record> 
________k=<question-record><question></question><answer><text>`expr $1 \* $j`</text><feedback></feedback><correct>1</correct></answer><clue>`expr $1 \* $j`</clue></question-record> 
________echo $k
____else
________echo 1
____fi
