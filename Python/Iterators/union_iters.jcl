...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>union_iterators</dc:title>
  </rdf:Description>
</rdf:RDF><version>6</version>

<data>
<title>union_iterators</title>
...
<gap-fill><question-record><question></question><answer><text>from itertools import chain</text><feedback></feedback><correct>1</correct></answer><clue>from itertools import chain </clue></question-record> 
it1 = iter([1,2,3]) 
it2 = iter([8,9,0]) 
for i in <question-record><question></question><answer><text>chain</text><feedback></feedback><correct>1</correct></answer><clue>chain</clue></question-record>(it1, it2): 
___print i
...
it3 = [2, 4, 6]
it4 = [3, 5, 7]
it5 = [x for x in <question-record><question></question><answer><text>chain</text><feedback></feedback><correct>1</correct></answer><clue>chain</clue></question-record>(it3, it4)]
print(it5)
--------------
[2, 4, 6, 3, 5, 7]</gap-fill>
</data>
