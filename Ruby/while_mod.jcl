...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>while modifier</dc:title>
  </rdf:Description>
</rdf:RDF><version>6</version>

<data>
<title>while modifier</title>
...
<gap-fill>begin 
____code 
end <question-record><question></question><answer><text>while conditional</text><feedback></feedback><correct>1</correct></answer><clue>while conditional</clue></question-record> </gap-fill>
</data>
