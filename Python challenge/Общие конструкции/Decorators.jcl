...
<gap-fill>def bread(func):
    def <question-record><question></question><answer><text>wrapper()</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record>:
        print()
        <question-record><question></question><answer><text>func()</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> 
        print(&quot;&amp;#x003C;\______/&amp;#x003E;&quot;)
    return wrapper
...
def ingredients(func):
    def <question-record><question></question><answer><text>wrapper()</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record>:
        print(&quot;#&amp;#x043F;&amp;#x043E;&amp;#x043C;&amp;#x0438;&amp;#x0434;&amp;#x043E;&amp;#x0440;&amp;#x044B;#&quot;)
        f<question-record><question></question><answer><text>unc()</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> 
        print(&quot;~&amp;#x0441;&amp;#x0430;&amp;#x043B;&amp;#x0430;&amp;#x0442;~&quot;)
    return wrapper
...
<question-record><question></question><answer><text>@bread</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> 
<question-record><question></question><answer><text>@ingredients</text><feedback></feedback><correct>1</correct></answer><clue></clue></question-record> 
def sandwich(food=&quot;--&amp;#x0432;&amp;#x0435;&amp;#x0442;&amp;#x0447;&amp;#x0438;&amp;#x043D;&amp;#x0430;--&quot;):
    print(food)
