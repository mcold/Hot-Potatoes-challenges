...
<gap-fill>l = list(filter(lambda x: x + 1, [-1, 0, 1]))
print(l)

----------
<question-record><question></question><answer><text>[0, 1]</text><feedback></feedback><correct>1</correct></answer><clue>[0, 1]</clue></question-record> </gap-fill>
</data>
