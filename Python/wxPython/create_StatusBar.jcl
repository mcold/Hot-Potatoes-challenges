...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>create StatusBar</dc:title>
  </rdf:Description>
</rdf:RDF><version>6</version>

<data>
<title>create StatusBar</title>
...
<gap-fill>import wx
class MainFrame(<question-record><question></question><answer><text>wx.Frame</text><feedback></feedback><correct>1</correct></answer><clue>wx.Frame</clue></question-record>):
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;def <question-record><question></question><answer><text>__init__(self, parent=None)</text><feedback></feedback><correct>1</correct></answer><clue>__init__(self, parent=None)</clue></question-record>:
&amp;#x003C;p style=&quot;text-indent:20%;&quot;&amp;#x003E;<question-record><question></question><answer><text>wx.Frame.__init__(self, parent, title=</text><feedback></feedback><correct>1</correct></answer><clue>wx.Frame.__init__(self, parent, title=</clue></question-record>&apos;No Statusbars&apos;)
&amp;#x003C;p style=&quot;text-indent:20%;&quot;&amp;#x003E;self.panel = <question-record><question></question><answer><text>wx.Panel(self)</text><feedback></feedback><correct>1</correct></answer><clue>wx.Panel(self) </clue></question-record>             # create Panel
&amp;#x003C;p style=&quot;text-indent:20%;&quot;&amp;#x003E;self.Show()
if __name__ == &apos;__main__&apos;:
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;app = <question-record><question></question><answer><text>wx.App(False)</text><feedback></feedback><correct>1</correct></answer><clue>wx.App(False)</clue></question-record> 
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;frame = <question-record><question></question><answer><text>MainFrame()</text><feedback></feedback><correct>1</correct></answer><clue>MainFrame()</clue></question-record> 
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;app.<question-record><question></question><answer><text>MainLoop()</text><feedback></feedback><correct>1</correct></answer><clue>MainLoop()</clue></question-record></gap-fill>
</data>
