...
<question-record><question></question><answer><text>(10..15).each do |n|</text><feedback></feedback><correct>1</correct></answer><clue>(10..15).each do |n|</clue></question-record> 
____<question-record><question></question><answer><text>print n, &apos; &apos;</text><feedback></feedback><correct>1</correct></answer><clue>print n, &apos; &apos;</clue></question-record> 
end

---------------------------
This will produce the following result &amp;#x2212;
10 11 12 13 14 15</gap-fill>
</data>
