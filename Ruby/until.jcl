...
____puts(&quot;Inside the loop i = #$i&quot; )
____$i +=1;
end <question-record><question></question><answer><text>until $i &amp;#x003E; $num</text><feedback></feedback><correct>1</correct></answer><clue>until $i &amp;#x003E; $num</clue></question-record> 
