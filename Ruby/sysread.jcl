...
if aFile
   content = aFile<question-record><question></question><answer><text>.sysread(20)</text><feedback></feedback><correct>1</correct></answer><clue>.sysread(20)</clue></question-record> 
   puts content
else
   puts &quot;Unable to open file!&quot;
end
This statement will output the first 20 characters of the file. The file pointer will now be placed at the 21st character in the file.</gap-fill>
</data>
