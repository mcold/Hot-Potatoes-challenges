...
<gap-fill>t = [True, False, False, True]
print(any(t), all(t))

---------------
<question-record><question></question><answer><text>True False</text><feedback></feedback><correct>1</correct></answer><clue>True False</clue></question-record> </gap-fill>
</data>
