...
<gap-fill>t = {1:1, 2:2, 3:3}
t.items()
print(t.items())

---------------
<question-record><question></question><answer><text>dict_items([(1, 1), (2, 2), (3, 3)])</text><feedback></feedback><correct>1</correct></answer><clue>dict_items([(1, 1), (2, 2), (3, 3)])</clue></question-record> </gap-fill>
</data>
