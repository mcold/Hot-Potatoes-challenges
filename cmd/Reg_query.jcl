...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>Reg_query</dc:title>
  </rdf:Description>
</rdf:RDF><version>6</version>

<data>
<title>Reg_query</title>
...
<gap-fill>&amp;#x003E; <question-record><question></question><answer><text>reg query</text><feedback></feedback><correct>1</correct></answer><clue>reg query</clue></question-record> &quot;HKLM\SOFTWARE\AutoHotkey&quot; <question-record><question></question><answer><text>/v Version</text><feedback></feedback><correct>1</correct></answer><clue>/v Version</clue></question-record> 

HKEY_LOCAL_MACHINE\SOFTWARE\AutoHotkey
    Version    REG_SZ    1.1.25.02</gap-fill>
</data>
