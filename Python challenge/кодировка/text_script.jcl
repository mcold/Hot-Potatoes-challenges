...
print &apos;a2 =&apos;,type(a),<question-record><question></question><answer><text>a.decode(&apos;utf8&apos;).encode(&apos;cp866&apos;)</text><feedback></feedback><correct>1</correct></answer><clue>a.decode(&apos;utf8&apos;).encode(&apos;cp866&apos;)</clue></question-record> 
print &apos;b =&apos;,type(b),b</gap-fill>
</data>
