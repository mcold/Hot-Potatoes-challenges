...
<gap-fill>print(max([(&apos;Alice&apos;, 5), (&apos;Bob&apos;, 3), (&apos;Charlie&apos;, 4), (&apos;Diana&apos;, 2)], key=lambda x: x[0]))
print(max(&apos;a&apos;, &apos;b&apos;))


-----------
<question-record><question></question><answer><text>(&apos;Diana&apos;, 2)</text><feedback></feedback><correct>1</correct></answer><clue>(&apos;Diana&apos;, 2)</clue></question-record> 
<question-record><question></question><answer><text>b</text><feedback></feedback><correct>1</correct></answer><clue>b</clue></question-record> </gap-fill>
</data>
