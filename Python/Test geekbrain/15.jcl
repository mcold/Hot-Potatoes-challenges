...
----------------
<question-record><question></question><answer><text>{1, 2, 3, 4, 5, 6}</text><feedback></feedback><correct>1</correct></answer><clue>{1, 2, 3, 4, 5, 6}</clue></question-record> </gap-fill>
</data>
