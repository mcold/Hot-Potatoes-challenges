...
<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <rdf:Description rdf:about="">
    ...
    <dc:title>class Methods and Variables</dc:title>
  </rdf:Description>
</rdf:RDF><version>6</version>

<data>
<title>class Methods and Variables</title>
...
class Box
____# Initialize our class variables
   ____@@count = 0
   ____def initialize(w,h)
      ________# assign instance avriables
      ________@width, @height = w, h

      ________@@count += 1
   ____end

   ____def self.printCount()
      ________puts &quot;Box count is : #@@count&quot;
   ____end
end
