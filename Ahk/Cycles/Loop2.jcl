...
Loop, 3
	MsgBox Repetition #<question-record><question></question><answer><text>%A_Index%</text><feedback></feedback><correct>1</correct></answer><clue>%A_Index%</clue></question-record> </gap-fill>
</data>
