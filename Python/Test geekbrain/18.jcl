...
<gap-fill>def mysum(a1, a2):
    return a1 + a2

test_tup = (1, 2)

print(mysum(<question-record><question></question><answer><text>*test_tup</text><feedback></feedback><correct>1</correct></answer><clue>*test_tup</clue></question-record>))</gap-fill>
</data>
