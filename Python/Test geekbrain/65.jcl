...
<gap-fill>s = 1
for i in range(5):
&amp;#x003C;p style=&quot;text-indent:10%;&quot;&amp;#x003E;for j in range(i):
&amp;#x003C;p style=&quot;text-indent:20%;&quot;&amp;#x003E;s *= 2
print(s)


----
<question-record><question></question><answer><text>1024</text><feedback></feedback><correct>1</correct></answer><clue>1024</clue></question-record> </gap-fill>
</data>
